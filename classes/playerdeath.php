...
class PlayerDeath extends ObjectData
{
	...
	public function getKillerString()
	{
		...
		{
			return '<a href="index.php?view=characters&name=' . urlencode($this->data['killed_by']) . '">' . htmlspecialchars($this->data['killed_by']) . '</a>';
		}
		else
		{
	...
	public function getMostDamageString()
	{
		...
		{
			return '<a href="index.php?view=characters&name=' . urlencode($this->data['mostdamage_by']) . '">' . htmlspecialchars($this->data['mostdamage_by']) . '</a>';
		}
		else
		{
