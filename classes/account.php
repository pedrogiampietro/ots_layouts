...
class Account extends ObjectData
{
	...
	public static $fields = array('id', 'name', 'password', 'premdays', 'lastday', 'email', 'key', 'create_ip', 'creation', 'premium_points', 'page_access', 'location', 'rlname', 'email_new', 'email_new_time', 'email_code', 'next_email', 'last_post', 'flag', 'tokens');
	public $players;
	public $playerRanks;
	public $guildAccess;
	public $bans;
...
*/
	...
	public function setTokens($value){$this->data['tokens'] = $value;}
	public function getTokens(){return $this->data['tokens'];}
