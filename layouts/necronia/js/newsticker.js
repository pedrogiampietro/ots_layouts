...
function OpenNews(id)
{
  ...
  document.getElementById(idButton).style.backgroundImage = "url('layouts/metro/images/content/minus.png')";
}
...
function CloseNews(id)
{
  ...
  document.getElementById(idButton).style.backgroundImage = "url('layouts/metro/images/content/plus.png')";
}
