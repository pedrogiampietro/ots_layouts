...
function OpenNews(id) {
  ...
  document.getElementById(idButton).style.backgroundImage = "url(./layouts/masteria/images/general/minus.gif)";
}
...
function CloseNews(id) {
  ...
  document.getElementById(idButton).style.backgroundImage = "url(./layouts/masteria/images/general/plus.gif)";
}