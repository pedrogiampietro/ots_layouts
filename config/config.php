...
# Layout Config
$config['site']['layout'] = 'pokestorm';
$config['site']['painel'] = '#ccc';
$config['site']['primeira_td'] = '#ddd';
$config['site']['segunda_td'] = '#eee';
$config['site']['download_page'] = false;
$config['site']['serverinfo_page'] = true;

/*
$config['site']['layout'] = 'tibiacom';
$config['site']['vdarkborder'] = '#ccc';
$config['site']['darkborder'] = '#ddd';
$config['site']['lightborder'] = '#eee';
$config['site']['download_page'] = false;
$config['site']['serverinfo_page'] = true; */