...
$config['site']['server_name'] = 'Alvoria';
$towns_list = array(
1 => 'Intiri',
3 => 'Salazart',
4 => 'Skyrim', 
...
$config['site']['item_images_url'] = 'images/all/';
...
# Layout Config
$config['site']['layout'] = 'thora';
$config['site']['vdarkborder'] = '#E9EBEC';
$config['site']['darkborder'] = '#E9EBEC';
$config['site']['lightborder'] = '#E9EBEC';
