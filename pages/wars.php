	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<ul class="nav nav-tabs">
				<li class="active"><a href="#active" data-toggle="tab" aria-expanded="true" class="btn btn-primary" data-toggle="tab">Active</a></li>
				<li><a href="#declarations" data-toggle="tab" aria-expanded="true" class="btn btn-primary" data-toggle="tab">Declarations</a></li>
				<li><a href="#history" data-toggle="tab" aria-expanded="true" class="btn btn-primary" data-toggle="tab">History</a></li>
			</ul>
