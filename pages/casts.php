...
?>
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<p>You can start casting by typing the command <b>!cast</b> ingame. Login to the server without account name to watch a live cast. If the cast has a password, enter the password in the password login field (still empty account name).
If you're playing cast online in <u>public mode</u>, you'll get an additional <span class="label label-info">5% experience bonus from 20 minutes of open cast.</span></p><br>
				...
				<table class="table table-striped table-condensed">
					<thead>
						<tr>
							...
							<th style="width:15%;">Spectator(s)</th>
