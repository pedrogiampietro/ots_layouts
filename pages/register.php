			...
			<form class="form-horizontal" role="form" action="?view=register" method="post">
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-lg-9">
							<input type="text" class="input" id="accountName" name="accountName" placeholder="4 to 30 characters" maxlength="30" required>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-9">
							<input type="password" class="input" id="password1" name="password1" placeholder="6 to 50 characters" maxlength="50" required>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-9">
							<input type="password" class="input" id="password2" name="password2" placeholder="Repeat Your Password" maxlength="50" required>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-9">
							<input type="text" class="input" id="email" name="email" placeholder="3 to 255 characters" maxlength="255" required>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-9">
							<input type="text" class="input" id="characterName" name="characterName" placeholder="2 to 30 characters" maxlength="30" required>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-9">
							<select class="input" name="vocation">
