...
if (isset($_POST['step']) && $_POST['step'] == 'docreate') {
	...
	elseif (strlen($s) < 2 || strlen($s) > 21)
		$e['name'] = 'A name must have at least 2 but no more than 21 letters!';
...
<div class="page_header border_box">
		<h3 class="page_title">	<span>Register</span>
...
<div class="page_body">
			...
			<form class="form-horizontal" role="form" action="?view=register" method="post">
				<center>
					<div class="form-group">
						...
						<div class="col-lg-9">
							<span class="warfg_input" style=""><input type="text" class="form-control" id="accountName" name="accountName" placeholder="4 to 30 characters" maxlength="30" required></span>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-9">
						<span class="warfg_input" style=""><input type="password" class="form-control" id="password1" name="password1" placeholder="6 to 50 characters" maxlength="50" required></span>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-9">
						<span class="warfg_input" style=""><input type="password" class="form-control" id="password2" name="password2" placeholder="Repeat Your Password" maxlength="50" required></span>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-9">
						<span class="warfg_input" style=""><input type="text" class="form-control" id="email" name="email" placeholder="3 to 255 characters" maxlength="255" required></span>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-9">
						<span class="warfg_input" style=""><input type="text" class="form-control" id="characterName" name="characterName" placeholder="2 to 21 characters" maxlength="21" required></span>
						</div>
					</div>';
					
					if($config['site']['verify_code'])
		$main_content .= '<script type="text/javascript">var verifya=1;</script><TR><TD width="150"><B>Code: </B></TD><TD colspan="2"><img src="?v=imagebuilder&image_refresher='.mt_rand(1,99999).'" border="0" alt="Image Verification is missing, please contact the administrator"></TD></TR>
	...
	$main_content .= '
					...
					<div class="text-center">
						<button type="submit" class="nice_button" name=step value=docreate>Submit</button>
						<button type="reset" class="nice_button">Cancel</button>
					</div>
					</center>
			</form>
		</div>
