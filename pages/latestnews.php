...
if (isset($last_threads[0])) {
    foreach($last_threads as $thread) {
        $main_content .= '
        <ul class="announcements-items">
        <li class="announcements-item">
            <a href="/en-US/announcements/Scout_1110_1W_1">
                <div class="announcements-item-info">
                    <div class="announcements-item-date">11/27/2019 at 10:00 p.m. (PT)</div>
                </div>
                <div class="announcements-item-inner">
                    <div class="headings">
                        <div class="scout layout1 color1">
                            <img src="layouts/pokemon/assets/images/15693216659a0dfdfd47e310645ca149f5715e659be40926f1.png">
                            <div class="title">
                                <div>' . htmlspecialchars($thread['post_topic']) . '</div>
                            </div>
                        </div>
                    </div>
