...
<div class="page_header border_box">';
	if ($logged)
		$main_content .= '<a class="nice_button" style="top:150px;position:relative;" href="?view=guilds&action=createguild"><i class="fa fa-plus"></i> Create a new guild</a>';
	$main_content .= '<h3 class="page_title"><span>Community</span>
	→ 	<span>Guilds</span>
   </h3>
