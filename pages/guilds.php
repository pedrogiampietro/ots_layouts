...
if ($action == '')
{
	...
	if (count($guilds_list) > 0) {
		$main_content .= '<table class="table table-striped"><thead><tr><th>Name</th><th width="20%">Members</th><th width="20%">Average Level</th></tr></thead><tbody>';
		...
		$main_content .= '<div class="alert alert-primary">No guilds found.</div>';
	}
