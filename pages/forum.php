...
<div class="page_header border_box">';
				if ($logged) {
					$main_content .= '<a class="nice_button" style="top:80px;left:550px;position:relative;" href="?view=forum&action=new_topic&section_id='.$section_id.'"><i class="fa fa-plus"></i> New Topic</a>';
				}
				$main_content .= '<h3 class="page_title"><span>Forum</span>
				→ 	<span>Board</span>
			   </h3>
							   <a href="?view=forum" class="back-to-account" title="Back to Forum" data-hasevent="1">Back to Forum</a>
					   </div>
			   <div class="page_body">
						   <div class="page_body">
				<table class="nice_table">
...
<div class="page_header border_box">';
				...
				$main_content .= '		<h3 class="page_title"><span>Forum</span>
				→ 	<span> / <a href="?view=forum&action=show_board&id='.$threads[0]['section'].'">'.$sections[$threads[0]['section']].'</a> / <b>'.htmlspecialchars($thread_name['post_topic']).'</b></span>
			   </h3>
							   <a href="?view=forum" class="back-to-account" title="Back to Forum" data-hasevent="1">Back to Forum</a>
					   </div>
			   <div class="page_body">
		...
		if(canPost($account_logged) || $group_id_of_acc_logged >= $group_not_blocked)
		{
			...
			if(isset($sections[$section_id]))
			{
				...
				if(!$saved)
				{
					...
					<div id="page_ucp" class="page page_ucp ">
			<div class="page_header border_box">
					<h3 class="page_title">	<span><a href="?view=forum">Boards</a> / <a href="?view=forum&action=show_board&id='.$section_id.'">'.$sections[$section_id].'</a> / <b>Post new thread</b></h3></span>
				</h3>
