	...
	$main_content .= '
		<div class="panel panel-default">
			<div class="panel-heading">';
				...
				$main_content .= '<h3 class="top"><a href="?view=forum">Boards</a> / <b>'.$sections[$section_id].'</b></h3>
			</div>
			<div class="body">
				<table class="table table-striped table-condensed">
					<thead>
	...
	if(!empty($thread_name['name']))
	{
		...
		<div class="panel panel-default">
			<div class="panel-heading">';
				...
				$main_content .= '<h3 class="top"><a href="?view=forum">Boards</a> / <a href="?view=forum&action=show_board&id='.$threads[0]['section'].'">'.$sections[$threads[0]['section']].'</a> / <b>'.htmlspecialchars($thread_name['post_topic']).'</b></h3>
			</div>
			<div class="body">
				<ul class="chat">';
					$number_of_rows = 0;
			...
			if(isset($thread['id']))
			{
				...
				if(!$saved)
				{
					...
					$main_content .= '
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="top"><a href="?view=forum">Boards</a> / <a href="?view=forum&action=show_board&id='.$thread['section'].'">'.$sections[$thread['section']].'</a> / <a href="?view=forum&action=show_thread&id='.$thread_id.'">'.htmlspecialchars($thread['post_topic']).'</a> / <b>Post new reply</b></h3>
							</div>
							<div class="body">
					...
					if(!$saved)
					{
						if(count($errors) > 0)
						{
							...
							$main_content .= '
								<div class="panel panel-default">
									<div class="panel-heading">
										<h3 class="top"><a href="?view=forum">Boards</a> / <a href="?view=forum&action=show_board&id='.$thread['section'].'">'.$sections[$thread['section']].'</a> / <a href="?view=forum&action=show_thread&id='.$thread['first_post'].'">'.htmlspecialchars($first_post['post_topic']).'</a> / <b>Edit post</b></h3>
									</div>
									<div class="body">
										<form class="form-horizontal" role="form" action="?" method="post">
			...
			if(isset($sections[$section_id]))
			{
				...
				if(!$saved)
				{
					...
					$main_content .= '
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="top"><a href="?view=forum">Boards</a> / <a href="?view=forum&action=show_board&id='.$section_id.'">'.$sections[$section_id].'</a> / <b>Post new thread</b></h3>
							</div>
							<div class="body">
								<form class="form-horizontal" role="form" action="?" method="post">
