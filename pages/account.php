	...
	<div class="page_body">
				...
				<form class="form-horizontal" role="form" action="?view=account" method="post">
						...
						<div class="text-center">
							...
							<a class="nice_button" href="?view=lostaccount">Account Lost?</a>
						</div>
...
else
{
	if($action == "")
	{
		$main_content .= '<div id="page_settings" class="page page_settings ">
	<div class="page_header border_box">
		<h3 class="page_title">	<span style="cursor:pointer;">Account Management</span>
	 <span style="cursor:pointer;"></span>
	</h3>
					<a href="http://200.98.129.17/?view=account&action=logout" class="back-to-account" title="Logout" data-hasevent="1">Logout</a>
			</div>
		...
		<div id="content_ajax"><style type="text/css" id="page_css"></style>
		<div id="page_ucp" class="page page_ucp ">
	<div class="page_body"><div id="ucp_top" class="warfg_account">
	<a href="" id="ucp_avatar" data-hasevent="1"><div></div><img src="./images/account/0_normal.png" width="124" height="124" alt="pedrook&#39;s Avatar"></a>

	<div id="ucp_info">
		<aside>
			<table width="100%">
				<tbody><tr>
					<td width="10%"><img src="./images/account/user.png"></td>
					<td width="40%">Account</td>
					<td width="50%">
												<span id="DisplayAccount">'.($account_name).'</span>
					</td>
				</tr>

				<tr>
					<td width="10%"><img src="./images/account/plugin.png"></td>
					<td width="40%">Email</td>
					<td width="50%">
											<span id="DisplayEmail">'.($account_email).'</span>
					</td>
				</tr>
			</tbody></table>
		</aside>
		...
		<aside>
			<table width="100%">
				...
				<tr data-tip="Earn donation points by donating money to the server">
					<td width="10%"><img src="./images/account/coins2.png"></td>
					<td width="40%">Donation points</td>
					<td width="50%">'.$account_logged->getCoins().'</td>
				</tr>
				<tr>
					<td width="10%"><img src="./images/account/date.png"></td>
					<td width="40%">Creation Date</td>
					<td width="50%">'.date("j F Y, g:i a", $account_created).'</td>
				</tr>
			</tbody></table>
		</aside>
	</div>
...
<ul class="accoun_panel_menu self_clear">

<li>
        <a href="?view=account&action=createcharacter" data-hasevent="1">
    <div class="icon border_box"><img src="./images/account/character.png" width="52" height="52" alt="race_human_male.jpg"></div>
    <span>Character Tools<i>Create a new Character</i></span>
</a>
    </li>

<li class="last-col">
        <a href="?view=account&action=changepassword" data-hasevent="1">
    <div class="icon border_box"><img src="./images/account/trade_engineering.jpg" width="52" height="52" alt="recruit_icon.jpg"></div>
    <span>Account settings<i>Change Password</i></span>
</a>
    </li>

<li class="last-col">
        <a href="?view=account&action=changeemail" data-hasevent="1">
    <div class="icon border_box"><img src="./images/account/trade_engineering.jpg" width="52" height="52" alt="recruit_icon.jpg"></div>
    <span>Account settings<i>Change Email</i></span>
</a>
    </li>

                        <li>
<a href="?view=account&action=generatekey" data-hasevent="1">
    <div class="icon border_box"><img src="./images/account/rk.png" width="52" height="52" alt="inv_misc_bag_10_black.jpg"></div>	
    <span>Recovery Key<i>Get a new recovery key</i></span>
</a>
</li>

<li class="last-col">
    <a href="?view=purchasecoins" data-hasevent="1">
<div class="icon border_box"><img src="./images/account/coins_icon.jpg" width="52" height="52" alt="coins_icon.jpg"></div>
<span>Donate<i>Support Us &amp; Gain points</i></span>
</a>
    </li>

<li>
        <a href="?view=shop" data-hasevent="1">
    <div class="icon border_box"><img src="./images/account/coins.png" width="52" height="52" alt="inv_misc_bag_10_black.jpg"></div>	
    <span>Item Store<i>Purchase items</i></span>
</a>
    </li>
...
';
		...
		<div id="page_ucp" class="page page_ucp ">
<div class="page_header border_box">
		<h3 class="page_title">Characters<span></span>
		
	 
	</h3></div>
	<center><a href="?view=account&action=createcharacter" class="nice_button" data-hasevent="1">Create Character</a>
	<a href="?view=account&action=deletecharacter" class="nice_button" data-hasevent="1">Delete Character</a></center>
	<div class="page_body">
				<div class="page_body"><form onsubmit="Settings.submitInfo(); return false" id="settings_info" class="page_form">
		</div>
		</div><table class="nice_table"><tbody>';
		...
		foreach ($account_players as $account_player) {
			...
			$main_content .= '<a class="btn btn-sm btn-primary" href="?view=account&action=editcharacter&name='.urlencode($account_player->getName()).'"><i class="fa fa-pencil"></i> Edit</a>
			<br>
			<br>
			<br>
			</div></td></tr>';
	...
	<div class="page_body">
				...
				<form class="form-horizontal" role="form" action="?view=account&action=changepassword" method="post">
						...
						<div class="form-group">
							...
							<div class="col-lg-9">
								<span class="warfg_input" style=""><input type="password" class="form-control" id="newpassword" name="newpassword" placeholder="4 to 30 characters" maxlength="30" required></span>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-9">
								<span class="warfg_input" style=""><input type="password" class="form-control" id="newpassword2" name="newpassword2" placeholder="4 to 30 characters" maxlength="30" required></span>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-9">
								<span class="warfg_input" style=""><input type="password" class="form-control" id="oldpassword" name="oldpassword" placeholder="4 to 30 characters" maxlength="30" required></span>
							</div>
						</div>
...
<div class="page_header border_box">
	...
	<div class="page_body">
				<div class="page_body"><p>Your password has been changed successfully.</p><p><a href="?view=account" class="btn btn-primary form-control">Back</a></p></div></div></div>';
...
<div class="page_header border_box">
	...
	<div class="page_body">
				<div class="page_body">
				<p>Please enter your password and the new email address. Make sure that you enter a valid email address which you have access to. <b>For security reasons, the actual change will be finalised after a waiting period of '.$config['site']['email_days_to_change'].' days.</b></p>';
					$main_content .= '<form class="form-horizontal" role="form" action="?view=account&action=changeemail" method="post">
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<span class="warfg_input" style=""><input type="text" class="form-control" id="new_email" name="new_email" value="'.htmlspecialchars($_POST['new_email']).'" placeholder="3 to 255 characters" maxlength="255" required></span>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<span class="warfg_input" style=""><input type="password" class="form-control" id="password" name="password" placeholder="4 to 30 characters" maxlength="30" required></span>
								</div>
							</div>
		...
		<span class="warfg_btn" style=""><input type="submit" value="Submit" class="styled-input"></span>
	</center>
...
<div class="page_header border_box">
	...
	<div class="page_body">
				<div class="page_body"><form onsubmit="Settings.submitInfo(); return false" id="settings_info" class="page_form">
				<p>To generate recovery key for your account please enter your password.</p>';
			$main_content .= '<form class="form-horizontal" role="form" action="?view=account&action=generatekey" method="post"><input type="hidden" name="generatekeysave" value="1">
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								<span class="warfg_input" style=""><input type="password" class="form-control" id="reg_password" name="reg_password" placeholder="4 to 30 characters" maxlength="30" required></span>
							</div>
						</div>
...
<div class="page_header border_box">
		<h3 class="page_title">	<span>Account</span>
	 → 	<span>Character Information Changed</span>
	</h3>
					<a href="?view=account" class="back-to-account" title="Back to Account" data-hasevent="1">Back to Account</a>
			</div>
	<div class="page_body"><p>The character information has been changed.</p><div class="text-center"><a href="?view=account" class="btn btn-primary">Back</a></div></div></div>';
					} else {
						$main_content .= '	<div id="content_ajax"><style type="text/css" id="page_css"></style>
		<div id="page_ucp" class="page page_ucp ">
<div class="page_header border_box">
	...
	<div class="page_body">
				<div class="page_body">Here you can see and edit the information about your character.<p>If you do not want to specify a certain field, just leave it blank.</p>';

						$main_content .= '
						<center>
						<table class="nice_table">
						<form class="form-horizontal" role="form" action="?view=account&action=editcharacter" method="post">
	...
	<div id="wrap_pm_editor" class="fusioneditor">
		<div style="float:right;display:none" id="fusioneditor_pm_editor_close">
							<div class="clear"></div>
		<div class="fusioneditor_toolbox" id="fusioneditor_pm_editor_toolbox" style="display:none;"></div>
	</div>
	<textarea class="form-control" rows="3" style="min-height:250px;min-width:550px;" contenteditable="true" id="comment" name="comment">'.$player->getCustomField("comment").'</textarea>
	...
	if ($action == "createcharacter")
	{
		if (isset($_POST['step']) && $_POST['step'] == 'create') {
			...
			if (count($config['site']['newchar_vocations']) > 1) {
				...
				$newchar_vocation = $config['site']['newchar_vocations'][1];
			}
			...
			$main_content .= '<div id="page_settings" class="page page_settings ">
	<div class="page_header border_box">
		<h3 class="page_title">	<span style="cursor:pointer;">Account</span>
	 → 	<span style="cursor:pointer;">Create Character</span>
	</h3>
					<a href="?view=account" class="back-to-account" title="Back to Account" data-hasevent="1">Back to Account</a>
			</div>

				<div class="page_body"><p>Please choose a name, vocation and sex for your character. <br/>In any case the name must not violate the naming conventions stated in the <a href="?view=rules" target="_blank" >Burmourne Rules</a>, or your character might get deleted or name locked.</p>
				<form class="form-horizontal" role="form" action="?view=account&action=createcharacter" method="post">
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								<span class="warfg_input" style=""><input type="text" class="form-control" id="newcharname" name="newcharname" placeholder="2 to 30 characters" onkeyup="checkName();" value="'.htmlspecialchars($newchar_name).'" maxlength="30" required></span>
							</div>
						</div>
...
<div class="ucp_divider"></div>
						...
						<center style="margin-bottom:10px;">
					<button type="submit" name="step" value="create" class="nice_button">Submit</button>
	</center>
