	...
	else
	{
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<p><a href="?view=register" >Create an account</a> if you do not have one yet.</p><br>
...
else
{
	if($action == "")
	{
		...
		<a class="btn btn-sm btn-danger pull-right" style="position:relative;top: 4px;" href="?view=account&action=logout"><i class="fa fa-sign-out"></i> Logout</a>
			...
			<table>
				...
				<tr>
					<td colspan="2">
						...
						<a href="?view=purchasecoins" class="btn btn-warning btn-sm pull-right"><i class="fa fa-cart-plus fa-lg"></i> Shop</a>
					</td>
				</tr>
			</table>
		</div>';
		...
		<div class="btn-group pull-right" style="top:-5px;position:relative;">
			...
			<a class="btn btn-sm btn-danger" style="margin-top: 1px;" href="?view=account&action=deletecharacter"><i class="fa fa-trash"></i> Delete a character</a>
		</div>
		</br>
		</br>
		</br>
		Characters</div><table style="margin-top: 10px;"class="table table-condensed table-content table-striped"><tbody>';
		...
		foreach ($account_players as $account_player) {
			...
			$main_content .= '<a style="margin-top:-px;" class="btn btn-sm btn-primary" href="?view=account&action=editcharacter&name='.urlencode($account_player->getName()).'"><i class="fa fa-pencil"></i> Edit</a></div></td></tr>';
		}
				...
				<form class="form-horizontal" role="form" action="?view=account&action=createcharacter" method="post">
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								<input type="text" class="form-control" id="newcharname" name="newcharname" placeholder="2 to 20 characters" onkeyup="checkName();" value="'.htmlspecialchars($newchar_name).'" maxlength="20" required>
							</div>
						</div>
