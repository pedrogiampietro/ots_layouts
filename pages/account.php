...
else
{
	if($action == "")
	{
		...
		<h3 class="top">Account Management</h3></div>
		<div class="body">';
			...
			<table class="table table-striped table-condensed table-bordered">
				<tr>
					...
					<td>
						...
						<span id="MaskedAccount" style="visibility:hidden;display:none">'.($account_name).'</span>
				...
				<tr>
					...
					<td>
						...
						<span id="MaskedEmail" style="visibility:hidden;display:none">'.($account_email).'</span>
		...
		</div><table class="table table-condensed table-content table-striped"><tbody>';
...
//########### CHANGE PASSWORD ##########
	if ($action == "changepassword") {
		...
		if (empty($new_password) && empty($new_password2) && empty($old_password)) {
			...
			$main_content .= '<div class="panel panel-default"><div class="panel-heading"><h3 class="top">Change Password</h3></div><div class="body">
			...
			if (!empty($show_msgs)) {
				...
				$account_logged->save();
				$main_content .= '<div class="panel panel-default"><div class="panel-heading"><h3 class="top">Password Changed</h3></div><div class="body"><p>Your password has been changed successfully.</p><p><a href="?view=account" class="btn btn-primary form-control">Back</a></p></div></div>';
...
//############# CHANGE E-MAIL ###################
	if($action == "changeemail")
	{
		...
		if($account_email_new_time < 10)
		{
			if($_POST['changeemailsave'] == 1)
			{
				...
				if(empty($change_email_errors))
				{
					...
					$main_content .= '<div class="panel panel-default"><div class="panel-heading"><h3 class="top">E-mail Address Change Requested</h3></div><div class="body"><p>You have requested to change your email address to <b>'.htmlspecialchars($account_email_new).'</b>. The actual change will take place after <b>'.date("j F Y, G:i:s", $account_email_new_time).'</b>, during which you can cancel the request at any time.</p><div class="text-center"><a href="?view=account" class="btn btn-primary">Back</a></div></div></div>';
				}
				else
				{
					//show errors
					...
					$main_content .= '<div class="panel panel-default"><div class="panel-heading"><h3 class="top">Change E-mail Address</h3></div><div class="body"><p>Please enter your password and the new email address. Make sure that you enter a valid email address which you have access to. <b>For security reasons, the actual change will be finalised after a waiting period of '.$config['site']['email_days_to_change'].' days.</b></p>';
		...
		else
		{
			if($account_email_new_time < time())
			{
				if($_POST['changeemailsave'] == 1)
				{
					...
					$account_logged->save();
					$main_content .= '<div class="panel panel-default"><div class="panel-heading"><h3 class="top">Email Address Changed</h3></div><div class="body"><p>You have accepted <b>'.htmlspecialchars($account_logged->getEmail()).'</b> as your new email address.</p><div class="text-center"><a href="?view=account" class="btn btn-primary">Back</a></div></div></div>';
				}
				else
				{
					$main_content .= '<div class="panel panel-default"><div class="panel-heading"><h3 class="top">Change Email Address</h3></div><div class="body"><p>Do you accept <b>'.htmlspecialchars($account_email_new).'</b> as your new email address?</p>';
					$main_content .= '<form class="form-horizontal" role="form" action="?view=account&action=changeemail" method="post">
					<fieldset>
						<div class="text-center">
							<input type="hidden" name="changeemailsave" value="1">
			...
			{
				$main_content .= '<div class="panel panel-default"><div class="panel-heading"><h3 class="top">Change of Email Address</h3></div><div class="body"><p>A request has been submitted to change the email address of this account to <b>'.htmlspecialchars($account_email_new).'</b>.</p><p>The actual change will take place on <b>'.date("j F Y, G:i:s", $account_email_new_time).'</b>.</p><p>If you do not want to change your email address, please click on "Cancel".</p>';
				$main_content .= '<form class="form-horizontal" role="form" action="?view=account&action=changeemail" method="post">
					<fieldset>
		...
		if($_POST['emailchangecancel'] == 1)
		{
			...
			$account_logged->set("email_new_time", 0);
			$account_logged->save();
			$main_content .= '<div class="panel panel-default"><div class="panel-heading"><h3 class="top">Email Address Change Cancelled</h3></div><div class="body"><p>Your request to change the email address of your account has been cancelled. The email address will not be changed.</p><div class="text-center"><a href="?view=account" class="btn btn-primary">Back</a></div></div></div>';
		}
	}
...
//############## GENERATE RECOVERY KEY ###########
	if($action == "generatekey")
	{
		...
		if($dontshowtableagain != 1)
		{
			...
			//show form
			$main_content .= '<div class="panel panel-default"><div class="panel-heading"><h3 class="top">Generate Recovery Key</h3></div><div class="body"><p>To generate recovery key for your account please enter your password.</p>';
			...
			if($player->isLoaded())
			{
				...
				if($account_logged->getId() == $player_account->getId())
				{
					if($_POST['editcharactersave'] == 1)
					{
						...
						$main_content .= '<div class="panel panel-default"><div class="panel-heading"><h3 class="top">Character Information Changed</h3></div><div class="body"><p>The character information has been changed.</p><div class="text-center"><a href="?view=account" class="btn btn-primary">Back</a></div></div></div>';
					} else {
						$main_content .= '<div class="panel panel-default"><div class="panel-heading"><h3 class="top">Edit Character Information</h3></div><div class="body">Here you can see and edit the information about your character.<p>If you do not want to specify a certain field, just leave it blank.</p>';
...
//### DELETE character from account ###
	if($action == "deletecharacter")
	{
						...
						if($account_logged->getId() == $player_account->getId())
						{
							if($account_logged->isValidPassword($password_verify))
							{
								if(!$player->isOnline())
								{
									...
									$player->save();
									$main_content .= '<div class="panel panel-default"><div class="panel-heading"><h3 class="top">Character Deleted</h3></div><div class="body"><p>The character '.htmlspecialchars($player_name).' has been deleted.</p><div class="text-center"><a class="btn btn-primary" href="?view=account">Back</a></div></div></div>';
								}
								else
		...
		if($dontshowtableagain != 1)
		{
			...
			$main_content .= '<div class="panel panel-default"><div class="panel-heading"><h3 class="top">Delete Character</h3></div><div class="body"><p>To delete a character enter the name of the character and your password.</p>';
...
//### UNDELETE character from account ###
				...
				if($player->isLoaded())
				{
					...
					if($account_logged->getId() == $player_account->getId())
					{
						if(!$player->isOnline())
						{
							...
							$player->save();
							$main_content .= '<div class="panel panel-default"><div class="panel-heading"><h3 class="top">Character Undeleted</h3></div><div class="body"><p>The character <b>'.htmlspecialchars($player_name).'</b> has been undeleted.</p><div class="text-center"><a href="?view=account" class="btn btn-primary">Back</a></div></div></div>';
	...
	if ($action == "createcharacter")
	{
		if (isset($_POST['step']) && $_POST['step'] == 'create') {
			...
			$main_content .= '<div class="panel panel-default"><div class="panel-heading"><h3 class="top">Create Character</h3></div><div class="body">
