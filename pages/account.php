				...
				<form class="form-horizontal" role="form" action="?view=account" method="post">
					<fieldset>
						...
						<div class="form-group">
							<label for="account_login" class="order-form">Account Name</label>
							<div class="col-lg-10">
							<div class="item"><input type="text" id="account_login" name="account_login" class="input" placeholder="Account" maxlength="30" required></div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
							<div class="item"><input type="password" id="password_login" name="password_login" class="input" placeholder="Password" maxlength="50" required></div>
							</div>
						</div>
...
else
{
	if($action == "")
	{
		...
		Characters</div><table class="overview-table"><tbody>';
