...
<div class="page_body">
			<div class="page_body">
			<p>Here you can see the list of all available houses, flats or guildhalls. Please select the game world of your choice. Click on any view button to get more information about a house or adjust the search criteria and start a new search.</p>';
	if($houses_town > 0)
	{
	...
	$main_content .= '<form class="form-horizontal" role="form" action="?view=houses" method="post">
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
						<span class="warfg_select" style=""><select class="form-control" name="town">';
								foreach($towns_list as $id => $town_n) {
									$main_content .= '<option value="'.$id.'">'.$town_n.'</option>';
								}
							$main_content .= '</select><div id="sbHolder_41502785" class="sbHolder" style="">
							</div></span>
						</div>
					</div>
