...
if(empty($id))
{
	...
	if($houses_town > 0)
	{
		...
		<td width=35%><b>Status</b></td><td width=20%></td>
		</tr>';
	...
	$main_content .= '<br><form class="form-horizontal" role="form" action="?view=houses" method="post">
	<fieldset>
	<div class="form-group">
	<label for="select" class="col-lg-1 control-label">Town</label>
	<div class="col-lg-10">
	...
	<div class="form-group">
	<label for="select" class="col-lg-1 control-label">Status</label>
	<div class="col-lg-10">
	...
	<div class="form-group">
	<label for="select" class="col-lg-1 control-label">Sort</label>
	<div class="col-lg-10">
