...
if(empty($id))
{
	...
	if($houses_town > 0)
	{
		$main_content .= '<table class="table table-striped"><tbody>
			<tr>
...
else
{
	...
	$main_content .= '<div class="panel panel-default"><div class="panel-heading"><h3 class="panel-title">House: '.$house['name'].'</h3></div><div class="panel-body"><table class="table table-striped"><tbody>
		<tr>
			<td></td>
			<td>
