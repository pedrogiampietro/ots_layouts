			...
			<!-- Main side -->
					<aside id="right">
						...
						<div id="slider_container" class="slider_container anti_blur" >
							<div id="slider">
																	<a href="#"><img src="layouts/metro/images/1.jpg" width="718" height="255" alt="" title="" /></a>
																	<a href="#"><img src="layouts/metro/images/2.jpg" width="718" height="255" alt="" /></a>
																	<a href="#"><img src="layouts/metro/images/3.jpg" width="718" height="255" alt="" /></a>
																	<a href="#"><img src="layouts/metro/images/4.jpg" width="718" height="255" alt="" title="" /></a>
																	<a href="#"><img src="layouts/metro/images/5.jpg" width="718" height="255" alt="" title="" /></a>
															</div>
						</div>
						<!-- Slider.End -->
						';
...
if (isset($last_threads[0])) {
    foreach($last_threads as $thread) {
        $main_content .= '
<div id="content_ajax"><div class="news_header border_box self_clear">
	<div class="left_side"><span class="title">' . htmlspecialchars($thread['post_topic']) . '</span></div>
    <div class="right_side">
    <h3 class="panel-title">
    <div class="post_meta_infos">
...
<br>
	   ...
	   <div class="post_header">
            ...
            </div><br><br><div class="social_media seperator"></div>
        ';
    }
} else {
