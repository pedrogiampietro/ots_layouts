...
$main_content .= '<div class="panel panel-default"><div class="panel-heading"><header>Ranking for '.htmlspecialchars($list_name).'</h3></div><div class="panel-body"><div class="text-center"><div class="btn-group">';
	foreach ($tmpSkills as $k => $v) {
		$main_content .= '<a href="?view=highscores&skill='.$k.'" class="vote_link_button '.($list == $k ? 'active' : '') .'">'.$v.'</a>';
	}

$main_content .= '</div></div><table id="searchArmoryResults"><thead><tr><th width="5%">#</th><th>Name</th><th width="25%">Vocation</th><th width="15%">'. ($list == "level" ? 'Level' : ($list == "magic" ? 'Magic Level' : 'Skill')) .'</th></tr></thead><tbody>';
...
$main_content .= '<center><div class="text-center"><ul class="pagination li">';
