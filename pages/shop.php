					...
					<tr>
						...
						<td width="35%">
							<div class="pull-right">
								' . (!$logged ? 'You need to <a href="?view=account&action=login">login</a> to buy this item.' : '<form class="form-horizontal" role="form" action="?view=shop&action=select_player" method="post"><input type="hidden" id="offer" name="buy_id" value="'.$item['id'].'"><button type="submit" class="nice_button">Buy</button></form>').'
							</div>
						</td>
					</tr>
				';
			...
			foreach ($offer_list['exclusive'] as $exclusive) {
				$exclusiveData .= '
					<tr>
						...
						<td width="35%">
							<div class="pull-right">
								' . (!$logged ? 'You need to <a href="?view=account&action=login">login</a> to buy this item.' : '<form class="form-horizontal" role="form" action="?view=shop&action=select_player" method="post"><input type="hidden" id="offer" name="buy_id" value="'.$exclusive['id'].'"><button type="submit" class="nice_button">Buy</button></form>').'
							</div>
						</td>
					</tr>
				';
			...
			foreach ($offer_list['outfit'] as $outfit) {
				$outfitData .= '
					<tr>
						...
						<td width="35%">
							<div class="pull-right">
								' . (!$logged ? 'You need to <a href="?view=account&action=login">login</a> to buy this item.' : '<form class="form-horizontal" role="form" action="?view=shop&action=select_player" method="post"><input type="hidden" id="offer" name="buy_id" value="'.$outfit['id'].'"><button type="submit" class="nice_button">Buy</button></form>').'
							</div>
						</td>
					</tr>
				';
			...
			foreach ($offer_list['mount'] as $mount) {
				$mountData .= '
					<tr>
						...
						<td width="35%">
							<div class="pull-right">
								' . (!$logged ? 'You need to <a href="?view=account&action=login">login</a> to buy this item.' : '<form class="form-horizontal" role="form" action="?view=shop&action=select_player" method="post"><input type="hidden" id="offer" name="buy_id" value="'.$mount['id'].'"><button type="submit" class="nice_button">Buy</button></form>').'
							</div>
						</td>
					</tr>
				';
			...
			foreach ($offer_list['misc'] as $misc) {
				$miscData .= '
					<tr>
						...
						<td width="35%">
							<div class="pull-right">
								' . (!$logged ? 'You need to <a href="?view=account&action=login">login</a> to buy this item.' : '<form class="form-horizontal" role="form" action="?view=shop&action=select_player" method="post"><input type="hidden" id="offer" name="buy_id" value="'.$misc['id'].'"><button type="submit" class="nice_button">Buy</button></form>').'
							</div>
						</td>
					</tr>
				';
...
?>
		...
		<?php if ($logged) { ?>
			<div class="pull-right">
				<span class="label btn-info" style="top:100px;position:relative;" >You have <?php echo $account_logged->getCustomField('premium_points'); ?> coins</span>
			</div>
		<?php } ?>
...
<?php
										...
										<div class="panel-body">
											<form class="form-horizontal" role="form" action="?view=shop&action=confirm_transaction" method="post">
												...
												<div class="text-center">
													<button type="submit" class="nice_button" value="Give">Send</button>
											...
											$main_content .= '
												<div class="panel panel-default">
													...
													<div class="panel-body">
														...
														<div class="text-center">
															<a class="nice_button" href="?view=shop">Return to the shop</a>
														</div>
													</div>
												</div>
											';
	...
	$main_content .= '
		...
		<div class="panel-body">
			...
			<div class="text-center">
				<a class="nice_button" href="'.$config['site']['url'].'">Return to the homepage</a>
			</div>
		</div>
	</div>';
