...
if(!empty($name))
{
	...
	if($player->isLoaded())
	{
		...
		$main_content .= '<div class="panel panel-default"><div class="panel-heading"><h3 class="panel-title">Character Information</h3></div><div class="panel-body"><table class="overview-table"><tbody>';
		...
		if (!$player->getHideChar()) {
			...
			<br>
			<br>
			<div class="panel panel-default"><div class="panel-heading"><h3 class="panel-title">Characters</h3></div><div class="panel-body"><table class="table table-condensed table-content table-striped">';
