...
if(!empty($name))
{
	...
	if($player->isLoaded())
	{
		...
		$main_content .= '<table border="0" cellspacing="1" cellpadding="4" width="100%"><tr bgcolor="2C3E50"><td colspan="2" style="font-weight:bold;color:white">Character Information</td></tr>';
		...
		$bgcolor = (($number_of_rows++ % 2 == 1) ?  $config['site']['darkborder'] : $config['site']['lightborder']);
		$main_content .= '<tr bgcolor="E9EBEC"><td>Sex:</td><td>' . htmlspecialchars((($player->getSex() == 0) ? 'female' : 'male')) . '</td></tr>';
		$bgcolor = (($number_of_rows++ % 2 == 1) ?  $config['site']['darkborder'] : $config['site']['lightborder']);
		$main_content .= '<tr bgcolor="' . $bgcolor . '"><td>Profession:</td><td>' . htmlspecialchars(Website::getVocationName($player->getVocation())) . '</td></tr>';
		$bgcolor = (($number_of_rows++ % 2 == 1) ?  $config['site']['darkborder'] : $config['site']['lightborder']);
		$main_content .= '<tr bgcolor="E9EBEC"><td>Level:</td><td>' . htmlspecialchars($player->getLevel()) . '</td></tr>';
		$bgcolor = (($number_of_rows++ % 2 == 1) ?  $config['site']['darkborder'] : $config['site']['lightborder']);
		...
		$bgcolor = (($number_of_rows++ % 2 == 1) ?  $config['site']['darkborder'] : $config['site']['lightborder']);
		$main_content .= '<tr bgcolor="E9EBEC"><td>Balance:</td><td>' . htmlspecialchars($player->getBalance()) . ' gold coins</td></tr>';
		$bgcolor = (($number_of_rows++ % 2 == 1) ?  $config['site']['darkborder'] : $config['site']['lightborder']);
		...
		{
			$bgcolor = (($number_of_rows++ % 2 == 1) ?  $config['site']['darkborder'] : $config['site']['lightborder']);
			$main_content .= '<tr bgcolor="E9EBEC"><td>Created:</td><td>' . date("j F Y, g:i a", $player->getCreateDate()) . '</td></tr>';
		}
		...
		foreach ($list as $number_of_items_showed => $slot)
		{
			...
			{
				$main_content .= '<td style="background-color:'.$config['E9EBEC'].'; text-align: center;">Soul:<br/>'. $player->getSoul() .'</td>';
			}
			if($itemsList->getSlot($slot) === false) // item does not exist in database
			{
				$main_content .= '<TD style="background-color: '.$config['E9EBEC'].';"><img src="' . $config['site']['item_images_url'] . $slot . $config['site']['item_images_extension'] . '" width="45"/></TD>';
			}
			else
			{
				$main_content .= '<TD style="background-color: '.$config['E9EBEC'].';"><img src="' . $config['site']['item_images_url'] . $itemsList->getSlot($slot)->getID() . $config['site']['item_images_extension'] . '" width="45"/></TD>';
			}
			...
			{
				$main_content .= '<td style="background-color: '.$config['E9EBEC'].'; text-align: center;">Cap:<br/>'. $player->getCap() .'</td>';
			}
		}
        ...
        $main_content .= '<td align=center ><table width=100%><tr><td align=center><table CELLSPACING="1" CELLPADDING="4" width="100%"><tr><td BGCOLOR="'.$config['site']['lightborder'].'" align="left" width="20%"><b>Health:</b></td>
        <td BGCOLOR="'.$config['site']['lightborder'].'" align="left">'.$player->getHealth().'/'.$player->getHealthMax().'<div style="width: 100%; height: 7px; border: 1px solid #000;"><div style="background-image: url(../images/skills/hp.png); width: ' . $hpPercent . '%; height: 7px;"></td></tr>
        <tr><td BGCOLOR="E9EBEC" align="left"><b>Mana:</b></td><td BGCOLOR="E9EBEC" align="left">' . $player->getMana() . '/' . $player->getManaMax() . '<div style="width: 100%; height: 7px; border: 1px solid #000;"><div style="background-image: url(../images/skills/mana.png); width: '.$manaPercent.'%; height: 7px;"></td></tr></table><tr>';
		...
		<tr><td BGCOLOR="E9EBEC" align="left"><b>Player Experience:</b></td><td BGCOLOR="E9EBEC" align="left">' . $player->getExperience() . ' EXP.</td></tr>
		<tr><td BGCOLOR="' . $config['site']['lightborder'].'" align="left"><b>To Next Level:</b></td><td BGCOLOR="'.$config['site']['lightborder'].'" align="left">You need <b>' . $expLeft . ' EXP</b> to Level <b>' . ($player->getLevel() + 1) . '</b>.<div title="' . (100 - $expLeftPercent)  . '% left" style="width: 100%; height: 5px; border: 1px solid #000;"><div style="background: red; width: '.$expLeftPercent.'%; height: 3px;"></td></tr></table></td></tr></table></tr></TABLE></td>';

		if($config['site']['show_skills_info'])
		{
			$main_content .= '<center><strong>Skills</strong><table cellspacing="0" cellpadding="0" border="0" width="200">
				
				<tbody>
                    <tr>
                        <td style="text-align: center;"><a href="?subtopic=highscores&list=experience"><img class="img-circle"<img src="images/skills/level.gif" alt="" style="border-style: none"/></td>
                        <td style="text-align: center;"><a href="?subtopic=highscores&list=magic"><img class="img-circle"<img src="images/skills/ml.gif" alt="" style="border-style: none"/></td>
                        <td style="text-align: center;"><a href="?subtopic=highscores&list=club"><img class="img-circle"<img src="images/skills/club.gif" alt="" style="border-style: none"/></td>
                        <td style="text-align: center;"><a href="?subtopic=highscores&list=sword"><img class="img-circle"<img src="images/skills/sword.gif" alt="" style="border-style: none"/></td>
                        <td style="text-align: center;"><a href="?subtopic=highscores&list=axe"><img class="img-circle"<img src="images/skills/axe.gif" alt="" style="border-style: none"/></td>
                        <td style="text-align: center;"><a href="?subtopic=highscores&list=distance"><img class="img-circle"<img src="images/skills/dist.gif" alt="" style="border-style: none"/></td>
                        <td style="text-align: center;"><a href="?subtopic=highscores&list=shield"><img class="img-circle"<img src="images/skills/def.gif" alt="" style="border-style: none"/></td>
                        <td style="text-align: center;"><a href="?subtopic=highscores&list=fishing"><img class="img-circle"<img src="images/skills/fish.gif" alt="" style="border-style: none"/></td>
                    </tr>
                    <tr>
                        <tr bgcolor="E9EBEC"><td style="text-align: center;">Level</td>
		...
		if($deads > 0)
			$main_content .= '<TABLE BORDER=0 CELLSPACING=1 CELLPADDING=4 WIDTH=100%><TR BGCOLOR="2C3E50"><TD COLSPAN=2 CLASS=white><B>Deaths</B></TD></TR>' . $dead_add_content . '</TABLE><br />';

		if(!$player->getHideChar())
		{
			$main_content .= '<TABLE BORDER=0><TR><TD></TD></TR></TABLE><TABLE BORDER=0 CELLSPACING=1 CELLPADDING=4 WIDTH=100%><TR BGCOLOR="2C3E50"><TD COLSPAN=2 CLASS=white><B>Account Information</B></TD></TR>';
			...
			if($account->getLastLogin())
				$main_content .= '<TR BGCOLOR="ECF0F1"><TD WIDTH=20%>Last login:</TD><TD>' . date("j F Y, g:i a", $account->getLastLogin()) . '</TD></TR>';
			else
				$main_content .= '<TR BGCOLOR="E9EBEC"><TD WIDTH=20%>Last login:</TD><TD>Never logged in.</TD></TR>';
			...
			$bgcolor = (($number_of_rows++ % 2 == 1) ?  $config['site']['darkborder'] : $config['site']['lightborder']);
			$main_content .= '<TR BGCOLOR="ECF0F1"><TD>Account&#160;Status:</TD><TD>';
			...
			$main_content .= '<br><TABLE BORDER=0><TR><TD></TD></TR></TABLE><TABLE BORDER=0 CELLSPACING=1 CELLPADDING=4 WIDTH=100%><TR BGCOLOR="2C3E50"><TD COLSPAN=5 CLASS=white><B>Characters</B></TD></TR>
			<TR BGCOLOR="ECF0F1"><TD><B>Name</B></TD><TD><B>Level</B></TD><TD><b>Status</b></TD><TD><B>&#160;</B></TD></TR>';
			...
			foreach($account_players as $player_list)
			{
				if(!$player_list->getHideChar())
				{
					...
					$main_content .= '<TR BGCOLOR="E9EBEC"><TD WIDTH=52%><NOBR>'.$player_number.'.&#160;'.htmlspecialchars($player_list->getName());
					$main_content .= ($player_list->isDeleted()) ? '<font color="red"> [DELETED]</font>' : '';
					$main_content .= '</NOBR></TD><TD WIDTH=25%>'.$player_list->getLevel().' '.htmlspecialchars($vocation_name[$player_list->getVocation()]).'</TD><TD WIDTH="8%"><b>'.$player_list_status.'</b></TD><TD><TABLE BORDER=0 CELLSPACING=0 CELLPADDING=0><FORM ACTION="?subtopic=characters" METHOD=post><TR><TD><INPUT TYPE="hidden" NAME="name" VALUE="'.htmlspecialchars($player_list->getName()).'"><input type="submit" value="View" '.htmlspecialchars($player_list->getName()).'" alt="View Eupozi" class="btn btn-xs btn-default" '.htmlspecialchars($player_list->getName()).'" SRC="'.$layout_name.'/images/buttons/sbutton_view.gif" BORDER=0 WIDTH=120 HEIGHT=18></TD></TR></FORM></TABLE></TD></TR>';
...
$main_content .= '<BR><BR><FORM ACTION="?subtopic=characters" METHOD=post><TABLE WIDTH=100% BORDER=0 CELLSPACING=1 CELLPADDING=4><TR><TD BGCOLOR="2C3E50" CLASS=white><B><center>Search Character</center></B></TD></TR><TR><TD BGCOLOR="ECF0F1"><TABLE BORDER=0 CELLPADDING=1><TR><TD>Name:</TD><TD><INPUT NAME="name" VALUE=""SIZE=29 MAXLENGTH=29></TD><TD><input type="submit" class="btn btn-default btn-sm" value="Search" name="Submit"></TD></TR></TABLE></TD></TR></TABLE></FORM>';
$main_content .= '</TABLE>';
