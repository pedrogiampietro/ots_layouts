...
if(!empty($name))
{
	...
	if($player->isLoaded())
	{
		...
		$main_content .= '<div class="panel panel-default"><div class="panel-heading"><h3 class="top">Character Information</h3></div><div class="body"><table class="table table-striped table-condensed table-bordered"><tbody>';
		...
		if ($deads > 0)
			$main_content .= '<div class="panel panel-default"><div class="panel-heading"><h3 class="top">Deaths</h3></div><div class="body"><table class="table table-striped table-condensed table-bordered"><tbody>' . $dead_add_content . '</tbody></TABLE></div></div>';

		// Account Information
		if (!$player->getHideChar()) {
			$main_content .= '<div class="panel panel-default"><div class="panel-heading"><h3 class="top">Account Information</h3></div><div class="body"><table class="table table-striped table-condensed table-bordered"><tbody>';
			...
			// Characters
			$main_content .= '<div class="panel panel-default"><div class="panel-heading"><h3 class="top">Characters</h3></div><div class="body"><table class="table table-striped table-condensed table-bordered">';
