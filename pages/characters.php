...
if(!empty($name))
{
	...
	if($player->isLoaded())
	{
		...
		if (!$player->getHideChar()) {
			...
			// Characters
			$main_content .= '<div class="panel panel-default"><div class="panel-heading"><h3 class="panel-title">Characters</h3></div><div class="panel-body"><table class="table table-striped">';
