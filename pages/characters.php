...
if(!empty($name))
{
	...
	if($player->isLoaded())
	{
		...
		$main_content .= '<div class="panel panel-default"><div class="panel-heading"><header>Character Information</h3></div><div class="panel-body"><table id="searchArmoryResults"><tbody>';
		...
		if ($deads > 0)
			$main_content .= '<div class="panel panel-default"><div class="panel-heading"><header>Deaths</h3></div><div class="panel-body"><table id="searchArmoryResults"><tbody>' . $dead_add_content . '</tbody></TABLE></div></div>';

		// Account Information
		if (!$player->getHideChar()) {
			$main_content .= '<div class="panel panel-default"><div class="panel-heading"><header>Account Information</h3></div><div class="panel-body"><table id="searchArmoryResults"><tbody>';
			...
			// Characters
			$main_content .= '<div class="panel panel-default"><div class="panel-heading"><header>Characters</h3></div><div class="panel-body"><table id="searchArmoryResults">';
...
if ($showSearch) {
	...
	/*$main_content .= '<div class="panel panel-default"><div class="panel-heading"><header>Search Character</h3></div><div class="panel-body"><table class="table table-striped table-condensed"><tbody>';
	$main_content .= '';
